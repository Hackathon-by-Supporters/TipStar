...
function getBackgroundColorByPoints(points: number): string {
    ...
    switch (colorIndex) {
        ...
        case 1:
            return "bg-gradient-to-r from-teal-200 to-teal-500" // 青系
        case 2:
            return "bg-gradient-to-r from-amber-200 to-yellow-500" // 黄色系
        case 3:
            return "bg-gradient-to-r from-teal-200 to-teal-500" // 緑系
        case 4:
            return "bg-gradient-to-r from-violet-600 to-indigo-600" // 紫系
        default:
...
function getCardBgColorByPoints(points: number): string {
    ...
    switch (colorIndex) {
        ...
        case 1:
            return "bg-gradient-to-r from-blue-200 to-cyan-200" // 青
        case 2:
            return "bg-gradient-to-br from-yellow-50 to-amber-100 border-yellow-200" // 黄
        case 3:
            return "bg-gradient-to-br from-green-50 to-green-100 border-green-200" // 緑
        case 4:
            return "bg-gradient-to-br from-purple-50 to-purple-100 border-purple-200" // 紫
        default:
                ...
                <div className={`max-w-md mx-auto rounded-xl shadow-md overflow-hidden border ${cardBgColor} mb-8`}>
                    <div className="p-8 space-y-4">
                        ...
                        <div className="mt-4 pt-4 border-t border-gray-100">
                            ...
                            <p className="text-sm text-gray-600">
                                次の色変更まであと <span className="font-medium">{pointsToNextColor}</span> ポイント
                            </p>
