...
export function GoogleLoginButton() {
    ...
    async function handleGoogleLogin() {
        ...
        try {
            // サーバーアクションを呼び出してGoogleログインを実行
            // signInWithGoogle関数内でリダイレクトが行われるため、
            // この関数は完了しない可能性があります
        ...
        <div className="space-y-6">
            ...
            <div className="text-center">
                <p className="text-xs text-gray-500">
                    ...
                    <a
                        href="/terms"
                        className="text-indigo-600 hover:text-indigo-500 underline decoration-wavy decoration-pink-400 underline-offset-2"
                    >
                        利用規約
                    </a>
                    および
